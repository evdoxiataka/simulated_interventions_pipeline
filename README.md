...
- **utils/model.py** : contains the code for automatic transformation of causal model to PyMC code defining a probabilistic linear regression model
- **utils/simulator.py** : contains the code for simulating interventions using PyMC's posterior predictive sampler
